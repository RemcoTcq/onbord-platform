...
export const StepNaturalLanguage = ({ data, onChange, onNext }: Props) => {
  ...
  const handleContinue = async () => {
    ...
    // Empty / too short → skip directly without animation
    if (q.length < MIN_CHARS) {
      onNext();
      return;
    }
    ...
    try {
      ...
      // Always proceed even if AI returned nothing
    ...
    <div className="space-y-6 relative">
      ...
      <div className="relative rounded-md border border-card-foreground/20 bg-card focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 focus-within:ring-offset-background transition-shadow">
        ...
        <Textarea
          ...
          placeholder="Ex: Développeur Python à Bruxelles 2 jours par semaine, FR/EN, Master… ou importez une offre d'emploi"
          rows={4}
